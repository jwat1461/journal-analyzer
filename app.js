...
const API_BASE = (() => {
  ...
  // Use relative paths when served by any HTTP/HTTPS server (localhost, tunnel, domain).
  // Only fall back to absolute localhost URL when opened directly as a local file.
